...
urlpatterns = [
    ...
    path('question/create/',views.question_create, name='question_create'), # xxx가 question/create/int형 question_id라는 숫자이면, views.py의 question_create라는 함수를 호출, http://localhost:8000/pybo/answer/create/숫자.../ 라는 패턴의 url에는 answer_create라는 별핑을 부여함.
